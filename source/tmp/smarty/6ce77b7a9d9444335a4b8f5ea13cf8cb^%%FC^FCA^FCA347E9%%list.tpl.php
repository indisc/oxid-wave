<?php /* Smarty version 2.6.31, created on 2019-02-06 22:16:41
         compiled from widget/product/list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'widget/product/list.tpl', 46, false),array('modifier', 'cat', 'widget/product/list.tpl', 52, false),array('function', 'math', 'widget/product/list.tpl', 47, false),array('function', 'counter', 'widget/product/list.tpl', 51, false),array('function', 'oxid_include_widget', 'widget/product/list.tpl', 59, false),)), $this); ?>
...
" target="_blank">
    ...
    <?php if ($this->_tpl_vars['products'] && ! empty ( $this->_tpl_vars['products'] )): ?>
        <?php $this->assign('productsCount', ((is_array($_tmp=$this->_tpl_vars['products'])) ? $this->_run_mod_handler('count', true, $_tmp) : count($_tmp))); ?>
