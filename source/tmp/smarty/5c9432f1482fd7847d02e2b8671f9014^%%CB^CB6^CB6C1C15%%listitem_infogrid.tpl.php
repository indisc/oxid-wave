...
" class="selectorsBox variant-dropdown js-fnSubmit clear">
 ...
 <?php echo smarty_function_oxmultilang(array('ident' => 'KG'), $this);?>
                        ...
                        <div class="actions">
                            <div class="btn-group">
                                <?php if ($this->_tpl_vars['blShowToBasket']): ?>
                                    <?php $this->_tag_stack[] = array('oxhasrights', array('ident' => 'TOBASKET')); $_block_repeat=true;smarty_block_oxhasrights($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
                                        <button type="submit" aria-label="<?php echo smarty_function_oxmultilang(array('ident' => 'TO_CART'), $this);?>
" class="btn btn-outline-dark hasTooltip" data-placement="bottom" title="<?php echo smarty_function_oxmultilang(array('ident' => 'TO_CART'), $this);?>
" data-container="body">
