...
class Details extends Details_parent {
	...
	public function getFinancingTable() {
		...
		/** @var $oPayment \OxidEsales\Eshop\Application\Model\Payment */
...
class_alias(\Sinkacom\CreditPlusModule\Controller\Details::class,'sccp_details');

/** CE Documentation relevant class, for automatic code completion */
if ( false ) {
	class Details_parent extends \OxidEsales\Eshop\Application\Controller\ArticleDetailsController {
