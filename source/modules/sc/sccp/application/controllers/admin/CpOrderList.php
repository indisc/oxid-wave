 ...
 */
//class sccp_cporder_list extends oxAdminList {
class CpOrderList extends \OxidEsales\Eshop\Application\Controller\Admin\AdminListController {
	...
	public function render() {
		...
		$sFolder = \OxidEsales\Eshop\Core\Registry::getRequest()->getRequestParameter("folder");
		...
		$sSearch = \OxidEsales\Eshop\Core\Registry::getRequest()->getRequestParameter("addsearch");
		$sSearchfld = \OxidEsales\Eshop\Core\Registry::getRequest()->getRequestParameter("addsearchfld");
	...
	protected function _buildSelectString( $oListObject = null ) {
		...
		$sSearchField = \OxidEsales\Eshop\Core\Registry::getRequest()->getRequestParameter('addsearchfld');
...
class_alias(\Sinkacom\CreditPlusModule\Controller\Admin\CpOrderList::class,'sccp_cporder_list');
