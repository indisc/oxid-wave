...
[{capture append="oxidBlock_content"}]
    <div class="accountDashboardView">
        <h1 id="accountMain" class="page-header"> test [{oxmultilang ident="MY_ACCOUNT"}]
        ...
        <div class="row">
                ...
                [{block name="account_dashboard_col1"}]
                    <div class="card">
                        <div class="card-header">
                            <a id="linkAccountPassword" href="[{oxgetseourl ident=$oViewConf->getSslSelfLink()|cat:"cl=account_password"}]">test [{oxmultilang ident="CHANGE_PASSWORD"}]</a>
            ...
            <div class="col-12 col-md-6">
                [{block name="account_dashboard_col2"}]
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a href="[{oxgetseourl ident=$oViewConf->getSelfLink()|cat:"cl=VetBonusHistoryController"}]">VetLine Bonus Bestell Historie</a>
                            <a href="[{oxgetseourl ident=$oViewConf->getSslSelfLink()|cat:"cl=VetBonusHistoryController"}]" class="btn btn-outline-dark btn-sm float-right edit-button">
                                <i class="fa fa-arrow-right"></i>
                            </a>
                        </div>
                        <div class="card-body">VetlineBonus Bestellhistorie
